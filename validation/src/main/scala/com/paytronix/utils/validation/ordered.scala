...
object ordered {
    def tooSmallErrorExclusive[A](a: A) = ValidationError("underflow", s"must be greater than $a")
    def tooSmallError[A](a: A)          = ValidationError("underflow", s"must be greater than or equal to $a")
    def tooLargeErrorExclusive[A](a: A) = ValidationError("overflow", s"must be less than $a")
    def tooLargeError[A](a: A)          = ValidationError("overflow", s"must be less than or equal to $a")
